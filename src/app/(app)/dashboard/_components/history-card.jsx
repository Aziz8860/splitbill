...
export const HistoryCard = ({ item }) => {
  return (
    <Link href={`/receipts/${item.id}/review`}>
      <div
        key={item.id}
        className="w-full border border-slate-200 bg-slate-100 px-3 py-2 rounded-lg space-y-2 transition-all duration-200 hover:bg-white hover:shadow-sm hover:border-slate-300 cursor-pointer"
      >
