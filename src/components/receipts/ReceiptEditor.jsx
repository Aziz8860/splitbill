...
export default function ReceiptEditor({ receipt, isNewReceipt = false }) {
  ...
  // Use the split method from the receipt data directly
  const correctSplitMethod = receipt?.splitMethod || 'evenly';
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div ref={receiptRef} className="bg-white shadow-md rounded-lg p-6 mb-6">
              ...
              <thead>
                <tr className="bg-gray-100">
                  ...
                  {people && people.length > 0 && (
                    <th className="text-left py-2 px-3">Yang harus bayar</th>
                  )}
                </tr>
              </thead>
              <tbody>
        ...
        {people && people.length > 0 && (
          <div className="border-t pt-4 mb-6">
            <h2 className="text-lg font-semibold mb-3">Yang harus bayar</h2>
