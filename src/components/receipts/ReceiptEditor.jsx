...
export default function ReceiptEditor({ receipt, isNewReceipt = false }) {
  ...
  const getPersonName = (personId) => {
    ...
    return person ? person.name : `Orang tidak diketahui`;
  };
  ...
  const shareToWhatsApp = () => {
    ...
    const message =
      ...
      `Split method: ${
        splitMethod === 'custom' ? 'Custom Split' : 'Split Sama Rata'
      }\n\n` +
  ...
  const handleSave = async () => {
    try {
      ...
      setError(err.message || 'Gagal menyimpan receipt');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div ref={receiptRef} className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            <h2 className="text-lg font-semibold">Barang/Items</h2>
          </div>
            ...
            <table className="min-w-full bg-white">
              <thead>
                <tr className="bg-gray-100">
                  <th className="text-left py-2 px-3">Nama Item</th>
                  <th className="text-right py-2 px-3">Harga</th>
                  <th className="text-right py-2 px-3">Jml</th>
                  <th className="text-right py-2 px-3">Total</th>
                  {people && people.length > 0 && (
                    <th className="text-left py-2 px-3">Yang harus dibayar</th>
                  )}
                </tr>
              </thead>
              <tbody>
                ...
                {items.length === 0 && (
                  <tr>
                    ...
                    >
                      Tidak ada item dalam receipt ini.
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        {people && people.length > 0 && (
          <div className="border-t pt-4 mb-6">
            <h2 className="text-lg font-semibold mb-3">Yang harus dibayar</h2>
        ...
        <div className="w-full mt-8">
          ...
          <div className="text-sm text-gray-500 mt-2 text-center">
            &copy; Tagihan dibagi oleh Splitbill
            <br />
      ...
      <div className="flex justify-end gap-4 mb-6 buttons-container">
        ...
        >
          ...
          {isLoading ? 'Memproses...' : 'Ekspor sebagai gambar'}
        </button>
      </div>
      ...
      {imageUrl && (
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-3">Preview Gambar</h2>
